  ...
  useEffect(() => {
    const fetchDataAndStore = async () => {
      try {
        ...
        localStorage.setItem('MONO', JSON.stringify({ data: newData, fetchTime }));
        setData(newData);
      } catch (error) {
      ...
      <table className={styles.table}>
        ...
        <tbody>
          <tr>
            ...
            <td className={styles.td}>{rateBuyUSD}</td>
            <td className={styles.td}>{rateSellUSD}</td>
          </tr>
          <tr>
            <td className={styles.td}>EUR</td>
            <td className={styles.td}>{rateBuyEUR}</td>
            <td className={styles.td}>{rateSellEUR}</td>
          </tr>
        </tbody>
      </table>

      {(isMobile || (isMinTablet && isMaxTablet) || isDesktop) && (
        <div className={styles.graphWrapper}>
          {isDesktop && (
            <>
              <div className={styles.graphUsd}>{rateBuyUSD}</div>
              <div className={styles.graphEur}>{rateBuyEUR}</div>
            </>
          )}
          ...
          {isMobile && (
            <>
              <svg className={styles.wave} width="320" height="72" viewBox="0 0 320 72" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
              ...
              <svg className={styles.gradientWave} width="320" height="88" viewBox="0 0 320 88" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          {isMinTablet && isMaxTablet && (
            <>
              <svg className={styles.wave} width="338" height="72" viewBox="0 0 338 72" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          {isDesktop && (
            <>
              <svg className={styles.wave} width="480" height="102" viewBox="0 0 480 102" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
              ...
              <svg className={styles.gradientWave} width="480" height="167" viewBox="0 0 480 167" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
